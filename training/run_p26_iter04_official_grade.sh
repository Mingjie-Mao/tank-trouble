...
log_path="training/logs/p26_iter04_official_grade.log"
pid_path="training/logs/p26_iter04_official_grade.pid"
net_path="training/models/p26_amortized_mpc_iter04.pt"
margin="0.16"
workers="10"

mkdir -p training/logs
printf "%s start P26 iter04 official grade\n" "$(date)" > "$log_path"
printf "%s\n" "$$" > "$pid_path"
